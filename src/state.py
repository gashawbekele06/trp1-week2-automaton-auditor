...
class AgentState(TypedDict):
    ...
    repo_path: NotRequired[Optional[str]]
    is_self_audit: NotRequired[bool]
    retry_counts: NotRequired[Dict[str, int]]
    snapshot_hash: NotRequired[Optional[str]]
    needs_detective_retry: NotRequired[bool]
    needs_judge_retry: NotRequired[bool]
    snapshot_hash: NotRequired[Optional[str]]
    needs_detective_retry: NotRequired[bool]
    needs_judge_retry: NotRequired[bool]
